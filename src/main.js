...
const createLoadMoreButtonTemplate = () => {
  return (
    `<button class="load-more" type="button"></button>`
  );
};
        ...
        <div class="card__inner">
          ...
          <div class="card__settings">
            <div class="card__details">
              <div class="card__dates">
                <button class="card__date-deadline-toggle" type="button">
                  <span class="card__date-status"></span>
                </button>
                ...
                <button class="card__repeat-toggle" type="button">
                  <span class="card__repeat-status"></span>
                </button>
                ...
                <fieldset class="card__repeat-days">
                  <div class="card__repeat-days-inner">
                    <input
                      ...
                      name="repeat"
                      value="mo"/>
                    <label class="card__repeat-day" for="repeat-mo-4"></label>
                    ...
                    <input
                      ...
                      value="tu"
                      checked/>
                    <label class="card__repeat-day" for="repeat-tu-4"></label>
                    ...
                    <input
                      ...
                      name="repeat"
                      value="we"/>
                    <label class="card__repeat-day" for="repeat-we-4"></label>
                    ...
                    <input
                      ...
                      name="repeat"
                      value="th"/>
                    <label class="card__repeat-day" for="repeat-th-4"></label>
                    ...
                    <input
                      ...
                      value="fr"
                      checked/>
                    <label class="card__repeat-day" for="repeat-fr-4"></label>
                    ...
                    <input
                      ...
                      value="sa"
                      id="repeat-sa-4"/>
                    <label class="card__repeat-day" for="repeat-sa-4"></label>
                    ...
                    <input
                      ...
                      value="su"
                      checked/>
                    <label class="card__repeat-day" for="repeat-su-4"></label>
                  </div>
                </fieldset>
              </div>
            ...
            <div class="card__colors-inner">
              <h3 class="card__colors-title"></h3>
              <div class="card__colors-wrap">
                <input
                  ...
                  name="color"
                  value="black"/>
                <label for="color-black-4" class="card__color card__color--black"></label>
                ...
                <input
                  ...
                  value="yellow"
                  checked/>
                <label for="color-yellow-4" class="card__color card__color--yellow" ></label>
                ...
                <input
                  ...
                  name="color"
                  value="blue"/>
                <label for="color-blue-4" class="card__color card__color--blue"></label>
                ...
                <input
                  ...
                  name="color"
                  value="green"/>
                <label for="color-green-4" class="card__color card__color--green"></label>
                ...
                <input
                  ...
                  name="color"
                  value="pink"/>
                <label for="color-pink-4" class="card__color card__color--pink"></label>
              </div>
            </div>
          </div>

          <div class="card__status-btns">
            <button class="card__save" type="submit"></button>
